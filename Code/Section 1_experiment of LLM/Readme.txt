...
The "prompt" folder contains the main materials for constructing the LLM experiments, including the human demographic information file "Study1_demographic_data.xlsx", the actual human experiment settings "Emo&TPP data.xlsx", the LLM settings "exp_model_class.py", and a general prompt file "person_all_game_prompt.json". The remaining files are intermediate files generated by running "run_parallel.py".

Note: The data files "Study1_demographic_data.xlsx" and "Emo&TPP data.xlsx" used in the code are not included in this repository due to privacy considerations. Please contact the authors to obtain the data download link from the cloud storage.
