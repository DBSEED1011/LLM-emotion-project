...
def main():
    """
    Main function to generate regression results tables.
    ...
    - Sample size statistics (n_groups) will change
    """
    ...
    with pd.ExcelWriter('LMM1_emotion_results.xlsx', engine='openpyxl') as writer:
    ...
    print(f"\n=== Files Saved ===")
    print("1. LMM1_emotion_results.xlsx - Tables in Excel format")
